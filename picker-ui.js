...
(function (root, factory) {
    ...
    function PickerUI(picker, options) {
        ...
        this.messages = $.extend({
            reset: "Reset",
            mustSelect: "Doctor, you must select something first. If you're indifferent, press Pass.",
            orderedAll: "You have ordered every available item. Well done, Doctor!",
            noItems: "There are no items that fit your criteria... Set some different options and try again?",
            resetWarning: "Reset your state? Your memories will be erased as if you had just left the sarcophagus."
